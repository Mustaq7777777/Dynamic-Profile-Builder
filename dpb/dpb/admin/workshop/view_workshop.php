...
<body>
  <div class="dashboard d-flex justify-content-between">
    ...
    <div class="workshop-details w-100 bg-light p-5">
 ...
 <?php
   ...
   if ($id) {
     ...
     $sqlSelectProject = "SELECT * FROM workshop WHERE id = $id";
     ...
     if (mysqli_num_rows($result) > 0) {
       ...
       if ( !$_SESSION['user_id']) {
         ...
         exit;
          ...
          echo '<p><b>Workshop Name:</b> ' . $row['w_name'] . '</p>';
          echo '<p><b>Place:</b> ' . $row['w_place'] . '</p>';
          echo '<p><b>Duration:</b> ' . $row['w_duration'] . '</p>';
          echo '<p><b>Date:</b> ' . $row['w_date'] . '</p>';
          echo '<p><b>Details:</b> ' . $row['w_details'] . '</p>';
        } else {
