  ...
  <div class="dashboard d-flex justify-content-between">
    ...
    <div class="posts-list w-100 p-5">
      ...
      <table class="table table-bordered">
        <thead>
          <tr>
            ...
            <th style="width:15%;">Sanctioned By</th>
      ...
      <?php
          ...
          $sqlSelect = "SELECT * FROM research WHERE user_id = $logged_in_user_id";
          ...
          if (mysqli_num_rows($result) > 0) {
            while ($row = mysqli_fetch_assoc($result)) {
              ...
              <tr>
                ...
                <td><?php echo $row['sanctioned_by']; ?></td>
                <td>₹<?php echo number_format($row['total_amount']); ?></td>
                <td><?php echo $row['status']; ?></td>
                <td><?php echo $row['type']; ?></td>
                <td>
                  <a class="btn btn-info" href="view_research.php?id=<?php echo $row['id']; ?>">View</a>
                  <a class="btn btn-warning" href="edit_research.php?id=<?php echo $row['id']; ?>">Edit</a>
                  <a class="btn btn-danger" href="delete_research.php?id=<?php echo $row['id']; ?>">Delete</a>
                </td>
              </tr>
            ...
            echo '<tr><td colspan="6">No research projects found for this user.</td></tr>';
          }
