...
<div class="course-details w-100 bg-light p-5">
  ...
  <?php
   ...
   if ($id) {
     ...
     $sqlSelectProject = "SELECT * FROM teaching WHERE id = $id";
     ...
     if (mysqli_num_rows($result) > 0) {
      ...
      echo '<p><b>Title:</b> '. $row['course_title'] . '</p>';
      echo '<p><b>Level:</b> ' . $row['course_level'] . '</p>';
      echo '<p><b>Year:</b> ' . $row['course_year'] . '</p>';
    } else {
